<cfoutput query="getSingleSuppliersRecord">
    <div class="container">
        <div class="border border-secondary text-center rounded p-3">
            <h1 class="title mb-0 fw-bold">Edit Supplier No. #SupplierID#</h1>
        </div>
        <form action="index.cfm" method="POST" name="AddNewSupplierForm">
            ...
            <div class="table-responsive rounded mt-4">
                ...
                <div>
                    ...
                    <input type="hidden" name="fuseaction" value="SaveSupplier">
                    <button type="submit" class="btn btn-primary">Save</button>
                    <a href="/suppliers/index.cfm?fuseaction=ViewSuppliers&showSuppliers=all" class="btn btn-secondary ms-2">Go Back</a>
                </div>
            </div>
        </form>
    </div>
